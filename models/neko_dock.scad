...
OL_W      = 9;          // окно под стекло экрана (w x h = 9x4 по замеру)
OL_H      = 4;          // окно под стекло
OL_R      = 1;          // скругление окна (стекло почти прямоугольное)
...
BTN_YS    = [10, 18, 26]; // чтоб верхняя не пересекалась с окном (низ окна ~38)
